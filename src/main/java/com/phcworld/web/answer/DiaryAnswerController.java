...
public class DiaryAnswerController {
	...
	public DiaryAnswer create(@PathVariable Long diaryId, String contents, HttpSession session) 
	...
	@DeleteMapping("/{id}")
	public String delete(@PathVariable Long diaryId, @PathVariable Long id, HttpSession session, Model model) 
